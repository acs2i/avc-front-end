      ...
      <Card title="Mes paramètres">
        <div className="gap-7 mt-2 grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 w-[80%] xl:w-[70%] mx-auto py-10">
          {LINKS_Params.map((link, i) => (
            <Link to={link.link} key={i} className={`w-[250px] h-[250px] bg-orange-400 border-2 border-orange-300 hover:brightness-105 hover:scale-110 text-white rounded-xl shadow-lg transition-all`}>
